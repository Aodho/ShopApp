...
/*
 * This class is used to update the products once they have been sold .
 * It contains getters and setters for for the products sale attributes 
 * These include the shipping cost, shipping date, date sold, the order number
 * the quantity sold, the company taking care of shipping, the product id and the costumer id
*/
@Entity
