...
/*
 * This class is used to update the customers.
 * It contains getters and setters for for the customers attributes 
 * These include the name, address, phone, fax, email,
 * credit limit, discount code, zip
 * It is also used to compare customers using the modified equals
*/
@Entity
@Table(name = "CUSTOMER")
@XmlRootElement
